<div class="space-y-4 md:space-y-8">
    ...
    <div class="bg-white p-4 rounded-md shadow-md">
        ...
        <h2 class="font-semibold text-center text-xl mb-4">List of Products</h2>

        <div class="relative h-96 overflow-x-auto overflow-y-auto">
        ...
        <div class="mb-2 mt-5 space-y-3 md:space-y-0 md:space-x-2 md:flex">
            ...
            <div class="relative">
                ...
                type="search"
                class="w-full md:w-64 block p-2 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
