<x-layouts.app>
    ...
    <div class="p-2 md:p-10">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 md:mx-32">

            @foreach ($highlights as $h)
                <div class="md:p-4 p-2">
                    <div class="bg-white rounded shadow p-4 hover:bg-blue-800 hover:text-white transition duration-300 ease-in-out">
                        <a href="">
    ...
    <div class="my-6 space-y-4">
        ...
        @endif
            <div class="grid grid-cols-1 md:grid-cols-5 md:mx-32 gap-4 md:gap-16">
                 @if ($loop->iteration % 2 == 0)
                    ...
                    <div class="space-y-4 md:space-y-8 md:col-span-2">
                        ...
                        <p><a href="" class="text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-green-600 dark:hover:bg-green-700 focus:outline-none dark:focus:ring-green-800">Learn More</a></p>
                    </div>
                ...
                @else
                    ...
                    <div class="space-y-4 md:space-y-8 md:col-span-2">
                        <h2 class="text-base font-medium md:text-xl md:font-semibold">{{ $category['name'] }}</h2>
                        <p class="text-sm font-thin text-gray-600 md:text-base md:font-normal">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Accusantium ducimus necessitatibus nobis, quis odit aperiam architecto similique vero et quasi.</p>
                        <p><a href="" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Learn More</a></p>
                    </div>
                @endif
            </div>
        </div>
    ...
    <div class="my-6">
        <h2 class="text-base font-medium text-center md:text-3xl">About Us</h2>
    </div>
